...
%% Copyright text
%%----------------------------------------
\copyrightnotice{João Azevedo, 2019} % Comment if not used
...
\begin{Prolog}
   ...
   \include{Preamble/acknows}  % the acknowledgments
  \include{Preamble/resumo} % the PT abstract
  \include{Preamble/abstract} % the abstract
  \cleardoublepage
  ...
  \listoftables
  \cleardoublepage
  \include{Preamble/acrconf}  % the list of abbreviations used
\end{Prolog}
